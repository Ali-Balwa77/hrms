  ...
  return (
    <div className="mb-3" ref={wrapperRef}>
      ...
      <div className="relative">
        ...
        >
          <span
            className={`block min-w-0 flex-1 text-left truncate ${
            ...
            {options.length > 0 ? (
              options.map((opt) => {
                ...
                return (
                  <label
                    key={opt.value}
                    className="flex min-w-0 items-center gap-2 px-4 py-2.5 text-sm text-slate-700 hover:bg-slate-50 cursor-pointer transition-colors duration-200"
                    title={opt.label}
                  >
                    <input
                      type="checkbox"
